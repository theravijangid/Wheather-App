...
function getfromSessionStorage() {
    ...
    if(!localCoordinates) {
        //agar local cooordinates nahi mile
        grantAccessContainer.classList.add("active");
    }
    else {
        const cooordinates = JSON.parse(localCoordinates);
        fetchUserWeatherInfo(cooordinates);
    }
}
...
async function fetchSearchWeatherInfo(city) {
    ...
    try{
        ...
        console.log("error");
        // alert("There is an error so reload the page");
